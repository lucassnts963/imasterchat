    ...
    <TooltipProvider>
      <div className="grid grid-cols-2 gap-3 rounded-xl border border-border bg-card/60 p-4 sm:grid-cols-3 xl:grid-cols-6">
        ...
        <Metric
          ...
          value={formatCurrency(stats.totalValue, defaultCurrency, locale)}
        ...
        <Metric
          ...
          label={t("avgDealSize")}
          value={formatCurrency(stats.avgValue, defaultCurrency, locale)}
        ...
        <Metric
          ...
          value={formatCurrency(stats.weightedValue, defaultCurrency, locale)}
