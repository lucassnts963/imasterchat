...
# O painel de notificações é `'use client'` e lê esta chave do bundle.
# Passar só em runtime não adianta: o valor precisa estar inlined, e
# sem ele a tela diz "servidor não configurado" mesmo com o par VAPID
# corretamente definido no servidor.
...
ENV NEXT_PUBLIC_SUPABASE_URL=$NEXT_PUBLIC_SUPABASE_URL \
    ...
    NEXT_PUBLIC_META_ES_CONFIG_ID=$NEXT_PUBLIC_META_ES_CONFIG_ID \
