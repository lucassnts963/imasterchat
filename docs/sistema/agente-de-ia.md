...
4. Duas chaves mestras separam "configurado" de "no ar": uma liga o agente e a outra libera a resposta automática. Sem as duas, nada é enviado sozinho.
