...
| Administração (item de menu) | — | `src/components/layout/sidebar.tsx:280-295` | Link renderizado só quando o perfil tem `isPlatformAdmin`. Gate cosmético: a página e as rotas recham no servidor. |
